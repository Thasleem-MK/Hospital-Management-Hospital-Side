...
//         {sidebarOpen && <span className="ml-3">Specialties</span>}
//       </Link>
//     </li>
//     <li>
//       <Link
...
//                 alt={hospitalData.name}
//                 className="w-44 h-44 rounded-lg object-cover mr-6"
//               />
//               <div>
//                 <h2 className="text-2xl font-bold text-green-800 mb-2">
//                   {hospitalData.name}
//                 </h2>
//                 <p className="text-green-600 mb-1">{hospitalData.address}</p>
...
//               </h3>
//               <p className="text-3xl font-bold text-green-600">
//                 {hospitalData.completedBookings}
//               </p>
//             </div>
//           </div>
...
//                   Total Bookings: {hospitalData.todayBookings}
//                 </p>
//                 <p className="text-green-600 text-lg">
//                   Completed: {hospitalData.completedBookings}
//                 </p>
//                 <p className="text-green-600 text-lg">
//                   Pending: {hospitalData.pendingBookings}
//                 </p>
//               </div>
